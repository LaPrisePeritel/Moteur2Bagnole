...
Vector2f
Matrix3::operator*(const Vector2f& vector) const
{
...
Matrix3
Matrix3::Translate(Vector2f position)
{
    return Matrix3({ {
      { 1, 0, position.x },
      { 0, 1, position.y },
...
Matrix3
Matrix3::SRT(const Vector2f& scale, const float& angle, const Vector2f& position)
{
...
Matrix3
Matrix3::TRS(const Vector2f& position, const float& angle, const Vector2f& scale)
{
